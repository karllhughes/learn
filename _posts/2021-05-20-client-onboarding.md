...
cta: Call
author: karl
date: 2024-02-02T16:53:55.871Z
img: /assets/posts/dev-marketing.png
---
Since I started [Draft.dev](https://draft.dev/), our team and the number of clients we work with has grown a lot. With this growth has come the need for robust, consistent processes that help us ensure that each client gets the absolute best, highest-quality technical content possible.
...
You came to the right place. We use a [proven method for generating topic clusters](https://draft.dev/learn/topic-clusters) around keywords relevant to your business. This will help you rank highly in search engines for terms that your readers are likely searching for.
...
Our service offering starts at $22,000 - $27,000 per quarter, depending on the scope, but we invite you to [book a call](https://draft.dev/call) for the most up-to-date pricing and service offerings. Most clients start with a quarterly 12-post pilot package and renew according to their needs each quarter.
...
You can see a sample video along with more information [here](https://draft.dev/video-tutorials). 

### Do you do technical ebooks?

Yes, we do offer ebook creation services, but it follows a slightly different process and pricing model than our technical blog post services. You can find more details and specifications on the process [here](https://draft.dev/learn/technical-ebooks).
