...
description: I set out to find the best PHP blogs actively publishing content
  today. Here are the 30 that topped my list.
...
Stitcher is a simple, content-rich resource for PHP blogging. The author gets into a groove in longer tutorials and drives home extensive knowledge, but some posts can be dry. The occasional walls of text distract from the blog’s ability to engage readers. Still, the code samples and depth of knowledge make Stitcher worth reading. On average, look for two new posts to be published every week.
...
PHP Builder is a programming resource that has featured articles, programming tutorials, and code samples since 2001. The posts range from beginner to advanced topics with all content created by PHP specialists and developers. However, the writing quality varies with the author. The formatting isn’t great, and I stumbled upon more than one broken link. However, there are a few writers that put in the effort, and it shows.
...
### 13. **[PHP The Right Way](https://phptherightway.com/)**
...
### 14. **[Colin O’Dell](https://www.colinodell.com/blog)**
...
### 17. **[Lorna Jane](https://lornajane.net/)**
...
### 18. **[Paul M. Jones](http://paul-m-jones.com/)**
...
### 21. **[IRC Maxwell](https://blog.ircmaxell.com/)**
...
### 22. **[PHP Cluster](https://www.phpcluster.com/)**
...
### 23. **[PHP Developer](http://phpdeveloper.org/)**
...
### 24. [Platform.sh](https://platform.sh/tags/php/)
...
### 25. **[PHP Magazine](http://phpmagazine.net/)**
...
### 26. **[PHP Coder](https://phpcoder.tech/)**
...
### 27. **[PHP Jabbers](https://www.phpjabbers.com/blog.php)**
...
### 28. [Exakat](https://www.exakat.io/en/blog/)
...
### 29. [Bootsity](https://bootsity.com/category/php)
