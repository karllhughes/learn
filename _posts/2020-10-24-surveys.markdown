...
While you can bring in your development team to build forms that capture customer responses, it’s usually much faster to use an off-the-shelf product or service. Below I’ve collected some of my favorite options.
...
**[Google Forms](https://www.google.com/forms/about/)** ($0) - Google Forms is simple, free, and it integrates into Google Sheets, allowing you to capture data right where you can use it.
